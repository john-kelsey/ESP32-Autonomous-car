...
Of course there are plug and play systems which you can buy, But those are very costly or you need a CS degree from MIT to understand the documentation, which can be little intimidating for beginners. I was one of those guys. So here's my Project. Thanks to all the people who have contributed to expanding this project and thanks for using it. 
